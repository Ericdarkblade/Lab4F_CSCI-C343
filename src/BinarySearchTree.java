public class BinarySearchTree {
    ...
    private void insert(int insertData, BinaryTreeNode parentNode) {
        ...
        switch (nextChildPath) {
            ...
            case setLeftChild -> parentNode.setLeft(new BinaryTreeNode(insertData, parentNode, null, null));

            case goRightChild -> insert(insertData, rightChildNode);
            case setRightChild -> parentNode.setRight(new BinaryTreeNode(insertData, parentNode, null, null));
        }
    }
